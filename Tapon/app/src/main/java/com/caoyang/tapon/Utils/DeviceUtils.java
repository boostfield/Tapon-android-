...
public class DeviceUtils {
    ...
    public static boolean hasInternet() {
        boolean flag;
        flag = ((ConnectivityManager) AppData.getContext().getSystemService(
    ...
    public static String getDeviceID() {
        if (DeviceID == null) {
            TelephonyManager tm = (TelephonyManager) AppData.getContext().getSystemService(Context.TELEPHONY_SERVICE);
