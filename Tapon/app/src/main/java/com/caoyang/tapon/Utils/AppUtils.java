...
public final class AppUtils {
    ...
    /**
     * 获取堆内存，每个手机都会给app一定的对内存，如果app的所使用的内存超过此额度，就会触发OOM错误
     */
    public static String getHeapSize() {
        ActivityManager manager = (ActivityManager) AppData.getContext().getSystemService(Context.ACTIVITY_SERVICE);
